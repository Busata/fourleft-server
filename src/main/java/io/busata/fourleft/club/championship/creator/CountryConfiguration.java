...
public enum CountryConfiguration {
    ...
    public StageConfiguration getOtherConfiguration(StageConfiguration configuration) {

        if(configuration == this.stageAForward) {
            return stageBForward;
        } else if (configuration == this.stageAReverse) {
            return stageBReverse;
        } else if (configuration == this.stageBForward) {
            return this.stageAForward;
        } else if (configuration == this.stageBReverse) {
            return this.stageBReverse;
        } else {
            throw new RuntimeException("Some scenario was not covered");
        }
    }
    ...
    public static StageConfiguration getReverse(StageConfiguration configuration) {
        for (CountryConfiguration value : CountryConfiguration.values()) {
            Optional<StageConfiguration> reverse = value.findReverse(configuration);
